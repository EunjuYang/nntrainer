...
public:
   ...
   * Currently support QINT4, QINT8, UINT16, UINT32, FP16 & FP32
   */
  enum class DataType {
   ...
   * @param d_type DataType QINT4 | QINT8 | UINT16 | UINT32 | FP16 | FP32
   ...
   * @param w width
   * @param fm format NCHW | HNWC
   * @param d_type Data Type QINT4 | QINT8 | UINT16 | UINT32 | FP16 | FP32
   * @param eff_dim_flag_ dimension bit flag to calculate the dynamic
   * dimension, rightmost is width
   */
