...
typedef struct {
  ...
  char modules_config[4096];    // Inline JSON string for modules pipeline +
                             // configs When set, module_config_path is ignored
                             // and modules.json / module config files are not
                             // loaded from disk.
