 ...
 *
 * @file   shadow_mha_core.h
 * @date   02 September 2024
 * @see    https://github.com/nntrainer/nntrainer
 *         https://arxiv.org/abs/1706.03762
 * @author Jijoong Moon <jijoong.moon@samsung.com>
 * @bug    No known bugs except for NYI items
 * @brief  This is custom_shadow_mha_core layer supports
...
#ifndef __SHADOW_MHA_CORE_H__
#define __SHADOW_MHA_CORE_H__
 ...
 * @brief SparseRatios
 */
class SparseRatios : public nntrainer::Property<std::string> {
public:
  SparseRatios(std::string value = "") { set(value); };
  static constexpr const char *key =
    "sparse_ratios";                        /**< unique key to access */
  using prop_tag = nntrainer::str_prop_tag; /**< property type */
};
 ...
 *        custom_shadow_mha_core_layer computes attention, while updating
 ...
 *
 */
WIN_EXPORT class ShadowMHACoreLayer : public nntrainer::LayerImpl {
public:
  /**
   * @brief Constructor of MhaCore Layer
   */
  WIN_EXPORT ShadowMHACoreLayer();
   ...
   */
  WIN_EXPORT
  ShadowMHACoreLayer(ShadowMHACoreLayer &&rhs) noexcept = default;

  /**
   * @brief  Move assignment operator.
   * @parma[in] rhs CustomMultiHeadAttentionLayer to be moved.
   */
  WIN_EXPORT ShadowMHACoreLayer &operator=(ShadowMHACoreLayer &&rhs) = default;
  ...
  WIN_EXPORT const std::string getType() const override {
    return ShadowMHACoreLayer::type;
  };
  ...
  inline static const std::string type = "shadow_mha_core";
...
private:
  std::tuple<
    ...
    shadow_mha_core_props; /**< shadow_mha_core layer properties */
  ...
  bool is_causal;
  std::vector<float> parsed_sparse_ratios;
...
}; // end of class ShadowMHACoreLayer
} // namespace causallm
