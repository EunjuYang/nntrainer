 ...
 */
class ApexMoeLayer : public nntrainer::LayerImpl {
public:
  /**
   ...
   */
  ~ApexMoeLayer() = default;

  /**
   * @brief  Move constructor.
   *  @param[in] ApexMoeLayer &&
   */
  ApexMoeLayer(ApexMoeLayer &&rhs) noexcept = default;

  /**
   * @brief  Move assignment operator.
   * @param[in] rhs ApexMoeLayer to be moved.
   */
  ApexMoeLayer &operator=(ApexMoeLayer &&rhs) = default;
