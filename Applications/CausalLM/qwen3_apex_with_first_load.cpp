...
void Qwen3ApexWithStaticCausalLM::setupParameters(json &cfg,
                                                  json &generation_cfg,
                                                  json &nntr_cfg) {
...
Qwen3ApexWithStaticCausalLM::createMlp(const int layer_id, int dim,
...
void Qwen3ApexWithStaticCausalLM::registerCustomLayers() {
