...
# ------------------------------------------------------------------
# 1. Build API Shared Library (libnntrainer_causallm_api.so)
# ------------------------------------------------------------------
include $(CLEAR_VARS)
...
# All core logic + API implementation
LOCAL_SRC_FILES := \
...
# ------------------------------------------------------------------
# 2. Build Test Application using the API Library
# ------------------------------------------------------------------
include $(CLEAR_VARS)
...
# Link against the API shared library
LOCAL_SHARED_LIBRARIES := nntrainer ccapi-nntrainer nntrainer_causallm_api
