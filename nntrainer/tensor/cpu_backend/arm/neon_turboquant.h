 ...
 *         cpu_backend.h. Only head_dim in {64, 128} is accelerated;
 *         callers are expected to fall back to the scalar reference for
 *         any other head_dim (the ARM dispatcher in
 *         arm_compute_backend.cpp handles this).
 */
